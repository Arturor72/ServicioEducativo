...
//	public static final String SISTEMAT_PROPERTIES_FILE = "src\\main\\java\\pe\\unfv\\fiei\\sistemat\\util\\properties.properties";
	...
	public static final String SISTEMAT_BDNAME = "dbservicio";
        ...
        public static final String USER_SELECT = "SELECT usr_cod, tip_usr_id, usr_nom, usr_apat, usr_amat, usr_dni, usr_gen, usr_cel, usr_mail, usr_user, usr_pass, usr_est, esp_id FROM tbl_usuario WHERE tip_usr_id = ? AND esp_id = ?";
