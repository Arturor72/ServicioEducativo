...
-- Schema dbServicio
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dbServicio` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `dbServicio` ;

-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_tipo_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_tipo_usuario` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_especialidad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_especialidad` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_usuario` (
  ...
  CONSTRAINT `fk_Usuario_TipoUsuario`
    ...
    REFERENCES `dbServicio`.`tbl_tipo_usuario` (`tip_usr_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Usuario_Especialidad1`
    FOREIGN KEY (`esp_id`)
    REFERENCES `dbServicio`.`tbl_especialidad` (`esp_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_curso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_curso` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_sede`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_sede` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_tipo_ambiente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_tipo_ambiente` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_ambiente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_ambiente` (
  ...
  CONSTRAINT `fk_Ambiente_Sede1`
    FOREIGN KEY (`sed_id`)
    REFERENCES `dbServicio`.`tbl_sede` (`sed_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Ambiente_TipoAmbiente1`
    FOREIGN KEY (`tip_amb_id`)
    REFERENCES `dbServicio`.`tbl_tipo_ambiente` (`tip_amb_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_tipo_Servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_tipo_Servicio` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_servicio_educativo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_servicio_educativo` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_alumno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_alumno` (
...
-- -----------------------------------------------------
-- Table `dbServicio`.`tbl_asistencia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbServicio`.`tbl_asistencia` (
  ...
  CONSTRAINT `fk_ServicioEducativo_has_Alumno_ServicioEducativo1`
    ...
    REFERENCES `dbServicio`.`tbl_servicio_educativo` (`ser_edu_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ServicioEducativo_has_Alumno_Alumno1`
    FOREIGN KEY (`al_id`)
    REFERENCES `dbServicio`.`tbl_alumno` (`al_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
